...
//  GHFollowers
//
//  Created by Mohamed Ibrahim on 11/19/20.
//
...
extension UIView {
    ...
    func anchor(
        ...
        translatesAutoresizingMaskIntoConstraints = false
        var anchoredConstraints = AnchoredConstraints()
        anchoredConstraints.leading = leadingAnchor.constraint(equalTo: leading, constant: left)
    ...
    func anchor(
        ...
        var anchoredConstraints = AnchoredConstraints()
        anchoredConstraints.leading = leadingAnchor.constraint(equalTo: leading, constant: left)
        anchoredConstraints.trailing = trailingAnchor.constraint(equalTo: trailing, constant: -right)
        anchoredConstraints.leading?.isActive = true
    ...
    func constrainHeight(anchor: NSLayoutDimension) {
        translatesAutoresizingMaskIntoConstraints = false
        heightAnchor.constraint(equalTo: anchor).isActive = true
    }
    
    func constrainWidth(anchor: NSLayoutDimension) {
        translatesAutoresizingMaskIntoConstraints = false
